...
# Versión adaptada para perfil hermes-ceo (usa el HERMES_HOME de goalworld ops)
set -euo pipefail

# === FIX para perfil hermes-ceo ===
# Forzamos el directorio de operaciones de goalworld, ignorando HERMES_HOME del perfil actual
