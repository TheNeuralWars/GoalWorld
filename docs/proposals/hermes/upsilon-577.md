# OA Proposal: Issue #577 — [OPENCODE] [P0][webapp][api] EconomyConfigBanner reads wrong fields from /api/economy/config
...
## Issue Body
## Objective
[P0][webapp][api] EconomyConfigBanner reads wrong fields from /api/economy/config
