# OA Proposal: Issue #638 — [OPENCODE] [P1][ops] Bulk create GitHub issues from GITHUB_ISSUES_BACKLOG CSV
...
## Issue Body
## Objective
[P1][ops] Bulk create GitHub issues from GITHUB_ISSUES_BACKLOG CSV
...
Original agent assignment: hermes
Epic: mundial-mvp
Blocked by: git-push
