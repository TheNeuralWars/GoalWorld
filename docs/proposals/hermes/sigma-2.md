# OA Proposal: Issue #2 — [OPENCODE] [Epic][P2] Post-Mundial backlog markets genesis vault mainnet
...
## Issue Body
## Objective
[Epic][P2] Post-Mundial backlog markets genesis vault mainnet
...
Epic: post-mundial
Blocked by: scope-freeze,orchestration
