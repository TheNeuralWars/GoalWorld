# OA Proposal: Issue #635 — [OPENCODE] [P2][economy] Add fee_burn to tokenomics_simulation S0 scenarios
...
## Issue Body
## Objective
[P2][economy] Add fee_burn to tokenomics_simulation S0 scenarios
