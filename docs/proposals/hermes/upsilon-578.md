# OA Proposal: Issue #578 — [OPENCODE] [P0][smart-contracts] Fix anchor test runner — surfpool missing breaks program tests
...
## Issue Body
## Objective
[P0][smart-contracts] Fix anchor test runner — surfpool missing breaks program tests
