# OA Proposal: Issue #575 — [OPENCODE] [P0][oracle] Deprecate migrate_config.ts — migrateConfig instruction does not exist
...
## Issue Body
## Objective
[P0][oracle] Deprecate migrate_config.ts — migrateConfig instruction does not exist
