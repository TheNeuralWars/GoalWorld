# OA Proposal: Issue #589 — [OPENCODE] [P1][webapp] Code-split DeFi/Club routes to reduce main bundle size
...
## Issue Body
## Objective
[P1][webapp] Code-split DeFi/Club routes to reduce main bundle size
