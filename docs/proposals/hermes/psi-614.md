# OA Proposal: Issue #614 — [OPENCODE] [P2][docs] Update docs merge stack merged #26 #35 remove blocked language
...
## Issue Body
## Objective
[P2][docs] Update docs merge stack merged #26 #35 remove blocked language
...
Blocked by: DO-NOT-REMERGE-32-34
