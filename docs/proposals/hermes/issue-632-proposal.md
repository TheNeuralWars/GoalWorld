# OA Proposal — Issue #632

## Title
[OPENCODE] [P2][ops] Add mundial-mvp label filter to check-tasks.sh
...
## Objective
## Objective
[P2][ops] Add mundial-mvp label filter to check-tasks.sh
...
Original agent assignment: cursor
...
- Rollback: revert branch `exp/opencode-issue-632` and close draft PR.
