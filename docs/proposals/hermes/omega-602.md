# OA Proposal: Issue #602 — [OPENCODE] [P1][smart-contracts][docs] Document FutureHook instructions as disabled
...
## Issue Body
## Objective
[P1][smart-contracts][docs] Document FutureHook instructions as disabled
