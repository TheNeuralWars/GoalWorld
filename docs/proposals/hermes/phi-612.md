# OA Proposal: Issue #612 — [OPENCODE] [P1][webapp][docs] Document CreateUser localStorage-only identity
...
## Issue Body
## Objective
[P1][webapp][docs] Document CreateUser localStorage-only identity
